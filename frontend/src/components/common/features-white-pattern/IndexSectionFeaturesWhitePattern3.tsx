    ...
    const features: Feature[] = [
        {
            ...
            description: "Milano'da öğrenim gören Türk öğrencilerin, her türlü sorunda destek alabilecekleri ve birlikte çözümler üretebilecekleri bir dayanışma ağı sunuyoruz."
        },
        {
            icon: (
            ...
            title: "Yeni Beceriler Kazanın",
            description: "Kariyerinizi ve kişisel gelişiminizi destekleyecek eğitim ve atölyelerle bilgi birikiminizi arttırın."
        }
    ]
