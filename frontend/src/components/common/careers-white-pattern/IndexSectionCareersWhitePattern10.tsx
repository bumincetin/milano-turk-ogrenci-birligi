        ...
        <section className="py-24 bg-white" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center'}}>
            <div className="container px-4 mx-auto">
                <div className="max-w-3xl mb-12">
                    <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-primary-500 bg-primary-100 font-medium uppercase rounded-full shadow-sm">Gönüllü Pozisyonlar</span>
                    <h3 className="mb-4 text-3xl md:text-4xl leading-tight font-medium text-black-900 font-bold tracking-tighter">MTÖB Ekibine Katılın</h3>
                    <p className="text-lg md:text-xl text-gray-500 font-medium">MTÖB olarak Milano'da öğrenim gören Türk öğrencileri desteklemek ve topluluk ruhunu güçlendirmek için gönüllü ekibimize katılacak yeni üyeler arıyoruz.</p>
                </div>
                                ...
                                <div className="bg-coolGray-50 group-hover:bg-coolGray-100 rounded-md shadow-md transition duration-200">
                                    <div className="flex flex-wrap items-start justify-between p-10 -mx-4">
                                        ...
                                        <div className="w-full lg:w-1/3 px-4 lg:text-right">
                                            <div className="inline-flex ml-auto items-center font-medium leading-6 text-primary-500 group-hover:text-primary-600 transition duration-200">
