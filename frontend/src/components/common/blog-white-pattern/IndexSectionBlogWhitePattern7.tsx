        ...
        <section className="py-24 bg-white" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundRepeat: 'no-repeat', backgroundPosition: 'left top'}}>
            <div className="container px-4 mx-auto">
                <div className="mb-8 md:mb-16 md:max-w-5xl">
                    <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-full shadow-sm">Blog</span>
                    ...
                    <p className="text-lg md:text-xl text-coolGray-500 font-medium">Milano'da yaşayan Türk öğrencilerin tecrübeleri ve etkinliklerinden haberdar olun.</p>
                </div>
                <ul className="flex flex-wrap mb-8 -mx-2 text-center">
                    <li className="w-full md:w-auto px-2">
                        <Link href="#" className="inline-block w-full py-2 px-4 mb-4 md:mb-0 text-sm text-coolGray-400 hover:text-green-500 hover:bg-green-200 font-bold rounded-md hover:shadow-sm">
                            Tüm Kategoriler
                        </Link>
                    </li>
                    <li className="w-full md:w-auto px-2">
                    ...
                    <li className="w-full md:w-auto px-2">
                        <Link href="#" className="inline-block w-full py-2 px-4 text-sm text-coolGray-400 hover:text-green-500 hover:bg-green-200 font-bold rounded-md hover:shadow-sm">
                            Öğrenci Yaşamı
                        </Link>
                    </li>
                </ul>
                <div className="flex flex-wrap items-center -mx-4 mb-12 md:mb-16">
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                                    src="/flex-ui-assets/images/blog/effect3.jpg"
                                    alt="Blog gönderisi görseli"
                                    width={300}
                                    height={200}
                                    quality={100}
                                />
                        ...
                        <div className="w-full md:flex-1 md:px-4">
                            <Link href="#" className="inline-block mb-4 text-2xl leading-tight text-coolGray-800 hover:text-coolGray-900 font-bold hover:underline">
                                Milano'da öğrenci olmanın getirdiği fırsatlar ve zorluklar
                            </Link>
                            <p className="mb-7 text-base md:text-lg text-coolGray-400 font-medium">
                                Milano'da eğitim gören Türk öğrencilerin deneyimlerinden dersler çıkarın...
                            </p>
                            <Link href="#" className="inline-flex items-center text-base md:text-lg text-green-500 hover:text-green-600 font-semibold">
                    ...
                    {/* Diğer blog gönderisi bölümleri benzer şekilde güncellenebilir */}
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                ...
                <div className="flex justify-center mx-auto max-w-max bg-white border border-coolGray-100 rounded-md shadow-lg">
                    <Link href="#" className="inline-flex items-center justify-center w-11 h-11 text-coolGray-300 hover:text-coolGray-400 font-medium border-r border-coolGray-100">
                        {/* Pagination SVG */}
                    </Link>
                    <Link href="#" className="inline-flex items-center justify-center w-11 h-11 text-coolGray-300 hover:text-green-500 font-medium border-r border-coolGray-100">1</Link>
                    <Link href="#" className="inline-flex items-center justify-center w-11 h-11 text-coolGray-300 hover:text-green-500 font-medium border-r border-coolGray-100">2</Link>
                    <Link href="#" className="inline-flex items-center justify-center w-11 h-11 text-coolGray-300 hover:text-green-500 font-medium border-r border-coolGray-100">3</Link>
                    <Link href="#" className="inline-flex items-center justify-center w-11 h-11 text-coolGray-300 hover:text-coolGray-400 font-medium">
