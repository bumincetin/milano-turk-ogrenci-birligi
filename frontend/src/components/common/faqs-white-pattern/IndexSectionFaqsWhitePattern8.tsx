                ...
                <div className="flex flex-wrap -mx-4">
                    ...
                    <div className="w-full md:w-1/2 px-4 mb-20 md:mb-0">
                        <div className="max-w-md">
                            ...
                            <h2 className="mb-4 text-4xl md:text-5xl leading-tight text-black-900 font-bold tracking-tighter">
                        ...
                        {faqs.map((faq: FAQ, index: number) => (
                            ...
                            >
                                <div className="flex items-center justify-between w-full pb-4">
                                    <h3 className="text-xl text-black-900 font-bold">
                                        {faq.question}
                                    </h3>
                                    <span className={`text-primary-500 transition duration-200 transform ${openIndex === index ? 'rotate-180' : ''}`}>
                                ...
                                <div className={`overflow-hidden transition-all duration-500 text-gray-500 font-medium ${openIndex === index ? 'max-h-40' : 'max-h-0'}`}>
                                    {faq.answer}
                                </div>
                            </div>
                        ))}
