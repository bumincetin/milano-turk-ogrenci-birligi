                ...
                <div className="flex flex-wrap items-center -mx-4 mb-12 md:mb-16">
                    ...
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                                    src="/flex-ui-assets/images/blog/work3.jpg"
                                    alt="Blog post image"
                                    width={300}
                                    height={200}
                                    quality={100}
                    ...
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                                    src="/flex-ui-assets/images/blog/work4.jpg"
                                    alt="Blog post image"
                                    width={300}
                                    height={200}
                                    quality={100}
                    ...
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                                    src="/flex-ui-assets/images/blog/effect4.jpg"
                                    alt="Blog post image"
                                    width={300}
                                    height={200}
                                    quality={100}
                    ...
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 mb-8 xl:mb-0 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                                    src="/flex-ui-assets/images/blog/learn2.jpg"
                                    alt="Blog post image"
                                    width={300}
                                    height={200}
                                    quality={100}
                    ...
                    <div className="flex flex-wrap items-center w-full xl:w-1/2 px-4 md:-mx-4">
                        <div className="w-full md:w-auto md:px-4">
                            <Link href="#" className="inline-block mb-6 md:mb-0 overflow-hidden rounded-md">
                                <Image 
                                    src="/flex-ui-assets/images/blog/macbook2.jpg"
                                    alt="Blog post image"
                                    width={300}
                                    height={200}
                                    quality={100}
