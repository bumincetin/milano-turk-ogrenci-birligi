                ...
                <div className="flex flex-wrap mb-24 lg:mb-18 justify-between items-center">
                    ...
                    <div className="w-full lg:w-auto">
                        <div className="flex flex-wrap justify-center items-center md:justify-start -mb-2">
                            <Link href="/pozisyonlar" className="inline-block py-4 px-6 mb-2 md:mb-0 w-full md:w-auto md:mr-5 text-lg leading-6 text-coolGray-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 border border-transparent rounded-md shadow-sm">
                                Açık Pozisyonlar
                            </Link>
                            <Link href="/hakkimizda" className="inline-block py-4 px-6 w-full md:w-auto text-lg leading-6 font-medium text-center text-coolGray-500 bg-white border border-coolGray-200 hover:border-coolGray-300 focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 rounded-md shadow-sm">
                                Hakkımızda
                            </Link>
                        </div>
                    </div>
                    ...
                    <div className="w-full lg:w-1/2 px-4 mb-14 lg:mb-0">
                        <div className="flex flex-wrap -mx-4">
                            ...
                            <ContactCard 
                                icon="email"
                                title="E-posta"
                                content={<Link href="mailto:iletisim@firma.com" className="text-lg md:text-xl text-coolGray-500 hover:text-coolGray-600 font-medium">
                                    iletisim@firma.com
                                </Link>}
                            />
                            <ContactCard 
                                icon="phone"
                                title="Telefon"
                                content={<p className="text-lg md:text-xl text-coolGray-500 font-medium">+90 555 123 45 67</p>}
                            />
                            <ContactCard 
                                icon="location"
                                title="Ofis"
                                content={<>
                                    <p className="text-lg md:text-xl text-coolGray-500 font-medium">Maslak, Büyükdere Cad.</p>
                                    <p className="text-lg md:text-xl text-coolGray-500 font-medium">İstanbul, 34485</p>
                                </>}
                            />
                            <ContactCard 
                                icon="social"
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-6">
                                    ...
                                    <textarea 
                                        ...
                                        className="block h-32 md:h-52 w-full py-2 px-3 appearance-none border border-coolGray-200 rounded-lg shadow-md text-coolGray-500 leading-6 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 resize-none"
                                        placeholder="Mesajınız..."
                                    />
                                </div>
                                <button type="submit" className="block w-full py-4 px-6 text-lg leading-6 text-coolGray-50 font-medium text-center bg-green-500 hover:bg-green-600 focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 rounded-md shadow-sm">
                                    Gönder
                                </button>
                            </form>
                        </div>
...
function SocialLink({ href, platform }: { href: string, platform: string }) {
    return (
        <Link href={href} className="text-green-500 hover:text-green-600">
