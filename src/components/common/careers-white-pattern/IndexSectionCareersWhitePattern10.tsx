        ...
        <section className="py-24 bg-white" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center'}}>
            <div className="container px-4 mx-auto">
                <div className="max-w-3xl mb-12">
                    <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-full shadow-sm">İş İlanları</span>
                    <h3 className="mb-4 text-3xl md:text-4xl leading-tight font-medium text-coolGray-900 font-bold tracking-tighter">Ekibimize Katılın</h3>
                    <p className="text-lg md:text-xl text-coolGray-500 font-medium">Felsefemiz basit — çeşitli, tutkulu insanlardan oluşan bir ekip kurun ve size en iyi işi yapmanızı sağlayacak bir kültür oluşturun.</p>
                </div>
                    ...
                    {[
                        {
                            ...
                            description: "Ekibimize katılacak orta seviye bir Front-end Developer arıyoruz.",
                            level: "Orta Seviye"
                        },
                        {
                            title: "Product Designer",
                            description: "Ekibimize katılacak orta seviye bir Product Designer arıyoruz.",
                            level: "Orta Seviye"
                        },
                        {
                            title: "Back-end Developer",
                            description: "Ekibimize katılacak junior seviye bir Back-end Developer arıyoruz.",
                            level: "Junior"
                        },
                        {
                            title: "Project Manager",
                            description: "Ekibimize katılacak orta seviye bir Project Manager arıyoruz.",
                            level: "Orta Seviye"
                        },
                        {
                            title: "UI/UX Designer",
                            description: "Ekibimize katılacak senior seviye bir UI/UX Designer arıyoruz.",
                            level: "Senior"
                        },
                        {
                            title: "SCRUM Master",
                            description: "Ekibimize katılacak orta seviye bir SCRUM Master arıyoruz.",
                            level: "Orta Seviye"
                        }
                    ].map((job, index) => (
                                    ...
                                    <div className="flex flex-wrap items-start justify-between p-10 -mx-4">
                                        ...
                                        <div className="w-full lg:w-1/3 px-4 lg:text-right">
                                            <div className="inline-flex ml-auto items-center font-medium leading-6 text-green-500 group-hover:text-green-600 transition duration-200">
                                                <span className="mr-2">İlanı Görüntüle</span>
