...
export default function IndexSectionCareersWhitePattern10() {
    return (
        <section className="py-24 bg-white" style={{backgroundImage: 'url("flex-ui-assets/elements/pattern-white.svg")', backgroundPosition: 'center'}}>
            <div className="container px-4 mx-auto">
                <div className="max-w-3xl mb-12">
                    <span className="inline-block py-px px-2 mb-4 text-xs leading-5 text-green-500 bg-green-100 font-medium uppercase rounded-full shadow-sm">Gönüllü Pozisyonlar</span>
                    <h3 className="mb-4 text-3xl md:text-4xl leading-tight font-medium text-coolGray-900 font-bold tracking-tighter">MTÖB Ekibine Katılın</h3>
                    <p className="text-lg md:text-xl text-coolGray-500 font-medium">MTÖB olarak Milano'da öğrenim gören Türk öğrencileri desteklemek ve topluluk ruhunu güçlendirmek için gönüllü ekibimize katılacak yeni üyeler arıyoruz.</p>
                </div>
                    ...
                    {[
                        {
                            ...
                            description: "Topluluğumuz için sosyal ve akademik etkinliklerin planlanmasına yardımcı olacak gönüllü bir Etkinlik Koordinatörü arıyoruz.",
                            level: "Gönüllü"
                        },
                        {
                            title: "Sosyal Medya Uzmanı",
                            description: "MTÖB'nin sosyal medya hesaplarını yönetebilecek, içerik üretebilecek bir Sosyal Medya Uzmanı arıyoruz.",
                            level: "Gönüllü"
                        },
                        {
                            title: "İletişim Sorumlusu",
                            description: "Topluluğumuz ile üyeler arasındaki iletişimi sağlayacak bir İletişim Sorumlusu arıyoruz.",
                            level: "Gönüllü"
                        },
                        {
                            title: "Akademik Danışman",
                            description: "Üyelerimize akademik konularda destek sunacak, akademik etkinlikler düzenleyebilecek bir Akademik Danışman arıyoruz.",
                            level: "Gönüllü"
                        },
                        {
                            title: "Grafik Tasarımcı",
                            description: "Etkinliklerimizi ve sosyal medya içeriklerimizi görsel olarak destekleyecek bir Grafik Tasarımcı arıyoruz.",
                            level: "Gönüllü"
                        },
                        {
                            title: "Web Geliştirici",
                            description: "Topluluğumuzun web sitesini güncelleyecek ve geliştirecek bir Web Geliştirici arıyoruz.",
                            level: "Gönüllü"
                        }
                    ].map((job, index) => (
