                    ...
                    <div className="w-full md:w-1/2 px-4 mb-20 lg:mb-0">
                        <div className="max-w-md mx-auto">
                            <h2 className="mb-8 text-4xl md:text-5xl font-heading font-bold text-coolGray-900 md:leading-15">
                                6.000+ startup ile birlikte büyüyün
                            </h2>
                            ...
                            <div className="flex flex-wrap items-center">
                                <Link 
                                    href="#" 
                                    className="inline-flex items-center justify-center px-7 py-3 h-14 w-full md:w-auto mb-2 md:mb-0 md:mr-4 text-lg leading-7 text-coolGray-800 bg-white hover:bg-coolGray-100 font-medium focus:ring-2 focus:ring-coolGray-200 focus:ring-opacity-50 border border-coolGray-200 rounded-md shadow-sm"
                                >
                                    Daha Fazla Bilgi
                                </Link>
                                <Link 
